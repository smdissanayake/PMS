...
//     id: number;
//     patient_id: number;
//     clinic_ref_no: string; // Add this line
//     admission_date: string;
//     discharge_date: string;
//     icu: string; // Changed from number to string
//     ward: string;
//     image_paths: string[];
//     created_at: string;
//     updated_at: string;
...
//         if (files.length > 0) {
//             if (files.length < 2) {
//                 // Changed validation: at least 2 images
...
//         try {
//             await axios.post("/api/ward-admissions", formData, {
//                 headers: {
...
//             fetchAdmissions(); // Refresh the list of admissions
//         } catch (err: any) {
...
//                             placeholder="Enter ICU details" // Updated placeholder
//                             className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200"
//                             required
//                         />
//                     </div>
